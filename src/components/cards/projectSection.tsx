...
export default function ProjectSection () {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col gap-32 mw">
            ...
            <div className="flex gap-10">
                <div className="flex">
                <article>
                <Image className="shift-u" src={'/fsmobile.png'} alt="website fullscreen screenshot" width={300} height={500}>
                </Image>
